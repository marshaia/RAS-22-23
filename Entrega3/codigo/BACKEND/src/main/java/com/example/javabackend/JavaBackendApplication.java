...
public class JavaBackendApplication {
    ...
    private static IRasbetPromocoes rasbetPromocoes;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rasbetPromocoes = new RasbetPromocoes(db);
        ...
        try {
            if (body.get("sports") != null) {
                return rasbetUtilizadores.registerUser(body.get("email").toString(), body.get("password").toString(), body.get("nome").toString(),
                        ...
                        body.get("endereco").toString(), body.get("telefone").toString(), body.get("tipo").toString(), body.get("sports").toString());
            }
            else {
                return rasbetUtilizadores.registerUser(body.get("email").toString(), body.get("password").toString(), body.get("nome").toString(),
                        body.get("datanascimento").toString(), body.get("nif").toString(), body.get("cc").toString(),
    ...
    public Map<String, Object> criaAposta(@RequestBody Map<String, Object> body) {
        ...
        try {
            ...
            if(usrId != null) {
                ...
                if (body.get("carteira").toString().equals("0")) carteira = false;
    ...
    public Map<String, Object> mudarEstadoAposta(@RequestBody Map<String, Object> body) {
        try {
            Integer adminID = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            if(adminID != null) {
                return rasbetApostas.mudarEstadoAposta(adminID, Integer.parseInt(body.get("idaposta").toString()), body.get("estado").toString());
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
            }
    ...
    @GetMapping("/admin/apostas")
    public List<Map<String,Object>> allApostas(@RequestHeader Map<String,Object> headers) {

        try {
            Integer adminID = rasbetUtilizadores.isValidSessionToken(headers.get("token").toString());
            if(adminID != null) return rasbetApostas.getApostas(-1);
            else throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"ERROR: "+e);
        }
    ...
    @GetMapping("/admin/apostadores")
    public List<Map<String,Object>> allApostadores(@RequestHeader Map<String,Object> headers) {
        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(headers.get("token").toString());
            if(usrId != null){
                return rasbetUtilizadores.getAllApostadores();
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
            }
    ...
    public List<Map<String,Object>> getGames() {
        try {
            return rasbetJogos.getGamesAdmin();
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"ERROR: "+e);
        }
    }

    @GetMapping("/jogosApostadores")
    public List<Map<String,Object>> getGamesApostadores() {

        try {
            return rasbetJogos.getGamesApostadores();
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"ERROR: "+e);
        }
    ...
    @GetMapping("/especialista/jogos")
    public List<Map<String,Object>> getEspecialistaGames(@RequestHeader Map<String,Object> headers) {
        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(headers.get("token").toString());
            if(usrId != null) return rasbetJogos.getEspecialistaGames(usrId);
            else throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"ERROR: "+e);
        }
    ...
    @PostMapping("/especialista/odds")
    public Map<String,Object> modificaOdds(@RequestBody Map<String,Object> body) {
        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            ObjectMapper mapper = new ObjectMapper();
            List<Object> resultados = mapper.readValue(body.get("resultados").toString(), List.class);
            if(usrId != null) return rasbetJogos.modificaOdds(usrId, Integer.parseInt(body.get("idjogo").toString()), resultados);
            else throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"ERROR: " + e);
        }
    ...
    public Map<String,Object> terminaJogo(@RequestBody Map<String, Object> body) {
        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            if(usrId != null) {
                rasbetJogos.terminaJogo(usrId, Integer.parseInt(body.get("game").toString()), body.get("winner").toString(), body.get("score").toString());
                return new HashMap<>();
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
    ...
    @PostMapping("/admin/criaJogo")
    public Map<String,Object> criaJogo(@RequestBody Map<String, Object> body) {
        try {
            Integer adminID = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            if(adminID != null) {
                ...
                if (body.get("completed").toString().equals("0")) completed = false;
                if (body.get("idcompeticao") != null) idCompeticao = Integer.parseInt(body.get("idcompeticao").toString());
                if (body.get("awayteam") != null) awayTeam = body.get("awayteam").toString();
                return rasbetJogos.criaJogo(adminID, completed, Integer.parseInt(body.get("iddesporto").toString()), idCompeticao, body.get("resultados").toString(), body.get("starttime").toString(), body.get("hometeam").toString(), awayTeam);
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
            }
    ...
    @PostMapping("/seguir")
    public Map<String,Object> segueJogo(@RequestBody Map<String, Object> body) {
        try {
            Integer userID = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            if(userID != null) {
                Integer add = Integer.parseInt(body.get("add").toString());
                if (add == 1) return rasbetJogos.startFollowing(userID, Integer.parseInt(body.get("idJogo").toString()));
                else return rasbetJogos.stopFollowing(userID, Integer.parseInt(body.get("idJogo").toString()));
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
            }
    ...
    public List<Map<String,Object>> changeVistoNotificacao(@RequestBody Map<String,Object> body) {

        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());

            if(usrId != null) return rasbetNotificacoes.changeVistoNotificacao(usrId, Integer.parseInt(body.get("idnotificacao").toString()));
            else throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
    ...
    @PostMapping("/admin/alteraPromo")
    public Map<String, Object> alteraEstadoPromo(@RequestBody Map<String, Object> body) {
        try {
            Integer adminID = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            if(adminID != null) {
                rasbetPromocoes.alteraEstadoPromocao(adminID, Integer.parseInt(body.get("idPromo").toString()));
                return new HashMap<>();
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
    ...
    public Map<String, Object> criaPromo(@RequestBody Map<String, Object> body) {
        try {
            Integer adminID = rasbetUtilizadores.isValidSessionToken(body.get("token").toString());
            if(adminID != null) {
                rasbetPromocoes.criaPromocao(adminID, body.get("descricao").toString());
                return new HashMap<>();
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
    ...
    public List<Map<String,Object>> getPromocoes(@RequestHeader Map<String,Object> headers) {

        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(headers.get("token").toString());
            if(usrId != null){
                return rasbetPromocoes.getPromocoes(usrId);
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
            }
    ...
    @GetMapping("/promos")
    public List<Map<String,Object>> getPromocoesAtivas(@RequestHeader Map<String,Object> headers) {

        try {
            Integer usrId = rasbetUtilizadores.isValidSessionToken(headers.get("token").toString());
            if(usrId != null){
                return rasbetPromocoes.getPromocoesAtivas(usrId);
            }
            else {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
            }

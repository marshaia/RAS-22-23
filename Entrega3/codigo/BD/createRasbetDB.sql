...
-- -----------------------------------------------------
-- Table `rasbetDB`.`jogo_has_apostador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rasbetDB`.`jogo_has_apostador` (
  `jogo_idjogo` INT NOT NULL,
  `apostador_utilizador_idutilizador` INT NOT NULL,
  PRIMARY KEY (`jogo_idjogo`, `apostador_utilizador_idutilizador`),
  INDEX `fk_jogo_has_apostador_apostador1_idx` (`apostador_utilizador_idutilizador` ASC) VISIBLE,
  INDEX `fk_jogo_has_apostador_jogo1_idx` (`jogo_idjogo` ASC) VISIBLE,
  CONSTRAINT `fk_jogo_has_apostador_jogo1`
    FOREIGN KEY (`jogo_idjogo`)
    REFERENCES `rasbetDB`.`jogo` (`idjogo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_jogo_has_apostador_apostador1`
    FOREIGN KEY (`apostador_utilizador_idutilizador`)
    REFERENCES `rasbetDB`.`apostador` (`utilizador_idutilizador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)

      ...
      <div class="w-1/3">
        ...
        <div class="w-2/3 flex flex-col justify-center align-middle">
            ...
            <template v-for="result in myGame?.resultados">
              <button @click.prevent="cart.addItemToCart(myGame?.idjogo ?? 0, result.idresultado)" class="w-36 m-2 hover:bg-rasbet-logo-gold hover:bg-opacity-25 border-2 rounded-xl border-rasbet-logo-gold border-opacity-30 py-2 px-4">
